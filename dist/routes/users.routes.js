...
router.post("/", auth_middleware_1.authorized, (0, auth_middleware_1.restrictTo)('admin', 'principle'), UserController.createUser);
router.get("/", auth_middleware_1.authorized, (0, auth_middleware_1.restrictTo)('admin', 'principle', 'teacher'), UserController.readUsers);
